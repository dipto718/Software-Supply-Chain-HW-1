...
# case 1
# tests that inclusion works
# with these valid inputs and
# that no exception is raised
# def test_inclusion():
# 	try:
# 		result = subprocess.run(
# 			['python3', 'main.py', '--inclusion 547323620', '--artifact', 'artifact.md'],
# 			capture_output = True,
# 			text = True
# 		)
# 		assert True
...
# case 2
# tests that consistency works
# with these valid inputs and
# that no exception is raised
# def test_consistency():
# 	try:
# 		result = subprocess.run(
# 			['python3', 'main.py', '--consistency', '--tree-id 1193050959916656506', '--tree-size 566822630', '--root-hash', '6e9b436995ed0978ea0acc8d86dc8375c08c7c0e2c8e62cc5fe4285fe63a024f'],
# 			capture_output = True,
# 			text = True
# 		)
# 		assert True
...
# case 3
# tests that consistency runs
# with invalid inputs and
# prints an error message rather
# than crashing
# def test_consistency_invalid():
# 	try:
# 		result = subprocess.run(
# 			['python3', 'main.py', '--consistency', '--tree-id 2193050959916656506', '--tree-size 566822630', '--root-hash', '6e9b436995ed0978ea0acc8d86dc8375c08c7c0e2c8e62cc5fe4285fe63a024f'],
# 			capture_output = True,
# 			text = True
# 		)
# 		assert True
...
# prints an error message rather
# than crashing
# def test_inclusion_invalid():
# 	try:
# 		result = subprocess.run(
# 			['python3', 'main.py', '--inclusion 54', '--artifact', 'artifact.md'],
# 			capture_output = True,
# 			text = True
# 		)
# 		assert True
...
# case 5
# makes sure that it work with a valid
# log index
# def test_get_log_entry():
# 	try:
# 		entry = main.get_log_entry(547323620)
# 		assert True
# 	except:
# 		assert False

# case 6
# makes sure that main itself still runs and compiles
# even if no commands are entered with it
# def test_main():
# 	try:
# 		result = subprocess.run(
# 			['python3', 'main.py'],
...
def test_consistency():
	...
	prev_checkpoint["rootHash"] = "6e9b436995ed0978ea0acc8d86dc8375c08c7c0e2c8e62cc5fe4285fe63a024f"
	try:
...
# an invalid input
# it should raise an exception
def test_consistency_invalid_rootHash():
	prev_checkpoint = {}
	prev_checkpoint["treeID"] = 1193050959916656506
	prev_checkpoint["treeSize"] = 566822630
	prev_checkpoint["rootHash"] = "709ghghb436995ed0978ea0acc8d86dc8375c08c7c0e2c8e62cc5fe4285fe63a024f"
	try:
		main.consistency(prev_checkpoint)
		assert False
	except:
...
# an invalid input
# it should raise an exception
def test_consistency_invalid_treeSize():
	prev_checkpoint = {}
	prev_checkpoint["treeID"] = 1193050959916656506
...
# an invalid input
# it should raise an exception
def test_consistency_invalid_treeID():
	prev_checkpoint = {}
